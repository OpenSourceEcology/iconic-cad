...
assert(validateCatalog({ ...catalog, entries: [{ ...catalog.entries[0], license_review: 'cleared', license: 'AGPL-3.0-only' }] }).ok, 'accepts a cleared license review for original examples');
